1. Створіть власний модуль та імпортуйте його
...
2. Практика з вбудованим модулем fs
...
3. Робота з директоріями через fs
...
5. Отримання інформації про систему за допомогою os
...
6. Створення простого HTTP-сервера
...
7. Робота з подіями через events
...
8. Хешування даних через crypto
...
10. Додаткове (за бажанням): створення власної структури проєкту
